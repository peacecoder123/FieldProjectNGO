                  ...
                  Column(
                    children: [
                      StatCard(
                        ...
                        icon:           const Icon(Icons.volunteer_activism_rounded, size: 20, color: AppColors.brand),
                        iconBackground: const Color(0xFFE8EDF5),
                        trend:          '12%',
                        trendUp:        true,
                      ),
                      ...
                      StatCard(
                        ...
                        icon:           const Icon(Icons.people_rounded, size: 20, color: AppColors.brand),
                        iconBackground: const Color(0xFFE8EDF5),
                        trend:          '8%',
                        trendUp:        true,
                      ),
                      ...
                      StatCard(
                        ...
                        icon:           const Icon(Icons.currency_rupee_rounded, size: 20, color: AppColors.brand),
                        iconBackground: const Color(0xFFE8EDF5),
                        trend:          '23%',
                        trendUp:        true,
                      ),
                      ...
                      StatCard(
                        ...
                        icon:           const Icon(Icons.inbox_rounded, size: 20, color: AppColors.brand),
                        iconBackground: const Color(0xFFE8EDF5),
                      ),
                    ],
                  ),
