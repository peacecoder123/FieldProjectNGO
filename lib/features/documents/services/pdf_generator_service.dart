        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              pw.Row(children: [
                pw.Text('Amount: ', style: const pw.TextStyle(color: PdfColors.black, fontSize: 11)),
              ...
              pw.Row(children: [
                pw.Text('Towards: ', style: const pw.TextStyle(color: PdfColors.black, fontSize: 11)),
                pw.Expanded(
              ...
              pw.Row(children: [
                pw.Expanded(
                  child: pw.RichText(
                    text: pw.TextSpan(children: [
                      const pw.TextSpan(
                          text: 'Contact No: ', style: pw.TextStyle(color: PdfColors.black, fontSize: 11)),
                      pw.TextSpan(
                ...
                pw.Expanded(
                  child: pw.RichText(
                    text: pw.TextSpan(children: [
                      const pw.TextSpan(
                          text: 'Pan No: ', style: pw.TextStyle(color: PdfColors.black, fontSize: 11)),
                      pw.TextSpan(
              ...
              pw.RichText(
                text: pw.TextSpan(children: [
                  const pw.TextSpan(
                      text: 'E-Mail: ', style: pw.TextStyle(color: PdfColors.black, fontSize: 11)),
                  pw.TextSpan(
            ...
            children: [
              ...
              pw.RichText(
                ...
                text: pw.TextSpan(
                  ...
                  children: [
                    const pw.TextSpan(
                        text: 'Throughout the internship, '),
                    pw.TextSpan(
                        text: displayName,
                        style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
                    const pw.TextSpan(
              ...
              pw.Paragraph(
                text:
                    'The management of $organisation appreciates their valuable contribution and wishes them continued success in their academic journey and future professional career.',
                style: const pw.TextStyle(fontSize: 13, lineSpacing: 6, color: PdfColors.black),
              ),
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              pw.Row(
                ...
                children: [
                  pw.Column(
                    crossAxisAlignment: pw.CrossAxisAlignment.start,
                    children: [
                      pw.Text('To,', style: pw.TextStyle(fontSize: 12, fontWeight: pw.FontWeight.bold, color: PdfColors.black)),
                      pw.Text('Management/ Administration,', style: pw.TextStyle(fontSize: 12, fontWeight: pw.FontWeight.bold, color: PdfColors.black)),
                      pw.Text(hospitalName, style: pw.TextStyle(fontSize: 12, fontWeight: pw.FontWeight.bold, color: PdfColors.black)),
                      pw.Text(address, style: pw.TextStyle(fontSize: 12, fontWeight: pw.FontWeight.bold, color: PdfColors.black)),
                    ]
                  ),
                  pw.Text('Date - $date', style: pw.TextStyle(fontSize: 13, fontWeight: pw.FontWeight.bold, color: PdfColors.black)),
                ]
              ),
              ...
              // 4. Salutation
              pw.Text('Respected Sir/Madam,', style: pw.TextStyle(fontSize: 12, fontWeight: pw.FontWeight.bold, color: PdfColors.black)),
              pw.SizedBox(height: 20),
              ...
              pw.Paragraph(
                ...
                style: pw.TextStyle(fontSize: 12, fontWeight: pw.FontWeight.bold, lineSpacing: 4, color: PdfColors.black),
              ),
                ...
                children: [
                  pw.Column(
                    ...
                    children: [
                      ...
                      pw.Text('Rutuja Puppalwar', style: pw.TextStyle(fontSize: 12, fontWeight: pw.FontWeight.bold, color: PdfColors.black)),
                      pw.Text('Secretary', style: pw.TextStyle(fontSize: 12, fontWeight: pw.FontWeight.bold, color: PdfColors.black)),
                      pw.Text('Jayashree Foundation .', style: pw.TextStyle(fontSize: 12, fontWeight: pw.FontWeight.bold, color: PdfColors.black)),
                    ]
                  ),
                  // Space for Stamp
                  pw.Container(
