...
class _VolunteerMeetingsTabState extends ConsumerState<VolunteerMeetingsTab> {
                ...
                children: [
                  Center(
                    child: Container(
                      ...
                      decoration: BoxDecoration(color: isDark ? AppColors.slate700 : AppColors.slate300, borderRadius: BorderRadius.circular(2)),
                    ),
                  ),
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(meeting.title, style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: isDark ? AppColors.slate100 : AppColors.slate900)),
                      ),
                  ...
                  Row(
                    children: [
                      ...
                      Text('${AppFormatters.displayDate(meeting.date)} at ${meeting.time}', style: TextStyle(fontSize: 14, color: isDark ? AppColors.slate300 : AppColors.slate600)),
                    ],
                  ),
                    ...
                    InkWell(
                      ...
                      child: Row(
                        children: [
                          ...
                          const SizedBox(width: 8),
                          Expanded(child: Text(meeting.link!, style: const TextStyle(fontSize: 14, color: AppColors.blue600, decoration: TextDecoration.underline))),
                          const SizedBox(width: 6),
                          const Icon(Icons.open_in_new_rounded, size: 14, color: AppColors.blue500),
                        ],
                      ),
                    ),
                  ],
                  ...
                  const Divider(),
                  const SizedBox(height: 16),
                  Text('Attendees (${meeting.attendees.length})', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: isDark ? AppColors.slate200 : AppColors.slate800)),
                  const SizedBox(height: 12),
                  Wrap(
                    ...
                    children: meeting.attendees.map(
                      (a) => Container(
                        ...
                        decoration: BoxDecoration(color: isDark ? AppColors.slate800 : AppColors.slate100, borderRadius: BorderRadius.circular(16), border: Border.all(color: isDark ? AppColors.slate700 : AppColors.slate200)),
                  ...
                  if (meeting.summary != null && meeting.summary!.isNotEmpty) ...[
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 8),
                        Text('Minutes of Meeting', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: isDark ? AppColors.slate200 : AppColors.slate800)),
                      ],
                    ),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(color: isDark ? AppColors.slate800 : AppColors.slate50, borderRadius: BorderRadius.circular(12), border: Border.all(color: isDark ? AppColors.slate700 : AppColors.slate200)),
                      child: Text(meeting.summary!, style: TextStyle(fontSize: 14, height: 1.5, color: isDark ? AppColors.slate300 : AppColors.slate700)),
                    ),
                  ],
  ...
  Widget build(BuildContext context) {
    ...
    return meetingsAsync.when(
      ...
      data: (meetings) {
        // Show ALL meetings to volunteers (view-only)
            ...
            Container(
              ...
              child: const Row(
                children: [
                  ...
                  SizedBox(width: 12),
                  Expanded(child: Text('Meetings are visible to you in view-only mode. Meeting summaries can be added by Members.', style: TextStyle(fontSize: 13, color: AppColors.blue500))),
                ],
              ),
            ),
            const SizedBox(height: 24),
                      ...
                      if (meeting.link != null && meeting.link!.isNotEmpty) ...[
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 4),
                            Expanded(child: Text(meeting.link!, style: const TextStyle(fontSize: 12, color: AppColors.blue600, decoration: TextDecoration.underline), overflow: TextOverflow.ellipsis)),
                          ],
                        ),
                      ],
                    ],
