...
abstract final class MockDataSource {
  ...
  static final List<TaskEntity> tasks = [
    ...
    const TaskEntity(
      ...
      assignedToName: 'Rahul Verma', assignedToEmail: 'rahul@hopeconnect.org',
    ...
    const TaskEntity(
      ...
      assignedToName: 'Sneha Kulkarni', assignedToEmail: 'sneha.k@email.com',
      assignedToType: AssigneeType.volunteer,
    ...
    const TaskEntity(
      ...
      assignedToName: 'Meera Nair', assignedToEmail: 'meera.n@email.com',
      assignedToType: AssigneeType.volunteer,
    ...
    const TaskEntity(
      ...
      assignedToName: 'Karan Mehta', assignedToEmail: 'karan.m@email.com',
      assignedToType: AssigneeType.volunteer,
      status: TaskStatus.approved, requiresUpload: false,
    ...
    const TaskEntity(
      ...
      assignedToName: 'Dr. Anjali Mehta', assignedToEmail: 'anjali@hopeconnect.org',
    ...
    const TaskEntity(
      ...
      assignedToName: 'Suresh Patil', assignedToEmail: 'suresh.p@email.com',
      assignedToType: AssigneeType.member,
      status: TaskStatus.approved, requiresUpload: false,
